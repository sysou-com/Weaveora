...
| 24 | 定位与范围（v1.8） | **电影感 = 长期定位，MVP 验收可量化**：15s 内成片、4-6 镜拼接、单镜 ≤6s、主体跨镜一致、720-1080p「可商用中高质」。**客群重切**：轨 2 主打 BYO 隐私/熟手提效，轨 1 主打电商垂直一致性工作流，不正面撞即梦/可灵大众市场。**MVP 收窄**：轨 2 安装包 / admin 完整集 / 观测面板移出 MVP 主线 | v1.8 裁定（1:A 2:A 3:A + deepseek-v4-pro 评审） |
